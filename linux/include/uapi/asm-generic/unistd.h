...
#define __NR_get_status 476
__SYSCALL(__NR_get_status, sys_get_status)

#define __NR_set_status 477
__SYSCALL(__NR_set_status, sys_set_status)

#undef __NR_syscalls
#define __NR_syscalls 478
